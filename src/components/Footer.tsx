...
const Footer = ({ language }: FooterProps) => {
  ...
  const socialLinks = [
    { icon: Facebook, href: "https://facebook.com/asncreativeagency", label: "Facebook" },
    { icon: Twitter, href: "https://twitter.com/asncreativeagency", label: "Twitter" },
    { icon: Instagram, href: "https://www.instagram.com/asncreativeagency/", label: "Instagram" },
    { icon: Linkedin, href: "https://linkedin.com/company/asncreativeagency", label: "LinkedIn" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Link to="/client-portal" className="block asn-body text-background/80 hover:text-background transition-colors">
