...
const WhatsAppButton = () => {
  const phoneNumbers = ["+919381617904", "+919848393730", "+919548175655"];
          ...
          <div className="flex flex-col gap-2">
            {phoneNumbers.map((number) => (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-black/90 hover:bg-green-700 text-white rounded-xl px-4 py-3 font-playfair text-lg tracking-wide border border-white/10 transition-all duration-200"
              >
